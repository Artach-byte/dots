...
todo_comments.setup {
    ...
    keywords = {
        ...
        TODO = { color = hint_blue, alt = { "TIP" } },
        HACK = { color = warning_orange },
        WARN = { color = warning_orange, alt = { "WARNING", "XXX" } },
        PERF = { color = perf_purple, alt = { "OPTIM", "PERFORMANCE", "OPTIMIZE" } },
        NOTE = { color = note_green, alt = { "INFO" } },
    },
